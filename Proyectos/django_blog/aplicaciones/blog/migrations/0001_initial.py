# Generated by Django 4.0 on 2021-12-20 07:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Categoria',
            fields=[
                ('name', models.CharField(max_length=100, primary_key=True, serialize=False, verbose_name='Nombre de la Categoría')),
                ('state', models.BooleanField(default=True, verbose_name='Categoría Activada/Categoría no Activada')),
                ('publish_date', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Creación')),
            ],
            options={
